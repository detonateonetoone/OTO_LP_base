...
function productsearchinput() {
    ...
    function searchTemplate() {
        return [
            ...
            '<input type="text" class="form-control search-input" placeholder="{{\'SEARCH\' | r}} {{\'PRODUCTS\' | r}}" ng-model="productSearchTerm" />',
            //'<i class="fa fa-search"></i>',
            '<span class="input-group-btn">',
            '<button type="submit" class="btn btn-default btn-search" ng-disabled="productSearchTerm == null || productSearchTerm == \'\'" ><i class="fa fa-search";"></i></button>',
            '</span>',
            '</div>',
            '</div>',
            '</form>'
...
function productsearchinputnav() {
    ...
    function searchNavTemplate() {
        return [
            ...
            '<form name="productSearchInput" ng-submit="executeSearch()">',
            '<div class="view-form-icon">',
            '<div class="input-group" style="margin:0 0 10px; background-color: #586372">',
            '<input type="text" class="form-control search-input" placeholder="{{\'SEARCH\' | r}} {{\'PRODUCTS\' | r}}" ng-model="productSearchTerm" style="color: #FFF;" />',
            //'<i class="fa fa-search"></i>',
            '<span class="input-group-btn">',
            '<button type="submit" class="btn btn-default btn-search" ng-disabled="productSearchTerm == null || productSearchTerm == \'\'"><i class="fa fa-search";"></i></button>',
            '</span>',
